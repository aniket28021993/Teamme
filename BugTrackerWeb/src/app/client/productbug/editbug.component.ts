...
export class EditBugComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private dashboardService: DashboardService, private messageService: MessageService, private apiurl: APIUrl, private miscellaneousService: MiscellaneousService, private bugService: BugService, private userService: UserService, private genericService: GenericService, private backlogService: BacklogService) { }
  ...
  ngOnInit() {
    ...
    this.GetAllMapUser();
    this.miscellaneousService.ChangeBreadcrumbData("EDIT BUG");
  }
  ...
  EditBug() {
    ...
    this.bugService.EditBug(this.ProductBacklogDataEdit).subscribe(proj => {
      this.FormDisabled = false;
      setTimeout(() => {
  ...
  FileUpload(ProductBacklogDataId, Type) {
